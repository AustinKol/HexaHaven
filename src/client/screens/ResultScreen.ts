...
const RULES_SECTIONS = [
  ...
  {
    heading: 'Setup',
    body: 'The island of Catan is made up of 19 hex tiles arranged randomly, each producing a different resource. Each hex (except the desert) is assigned a number token. Players start with 2 settlements and 2 roads placed on the board.',
  },
  {
  ...
  {
    heading: 'The Robber',
    body: 'Rolling a 7 activates the Robber. Players holding more than 7 resource cards must discard half (rounded down). The active player moves the Robber to any hex tile, blocking its production, and steals 1 random card from a player with a settlement or city adjacent to that tile.',
  },
  {
  ...
  {
    heading: 'Trading',
    body: 'On your turn you may trade freely with other players. The bank accepts 4 of the same resource for 1 of any other. Coastal harbors improve this: 3:1 harbors accept any 3 resources, and 2:1 harbors accept 2 of a specific resource for 1 of any other.',
  },
  {
